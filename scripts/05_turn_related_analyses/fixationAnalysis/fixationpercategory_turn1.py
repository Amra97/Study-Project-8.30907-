...
# 3. Filter for first entry turns (entry_nr == 1)
turn_rows = df[(df['isNewTurn'] == True) & (df['entry_nr'] == 1)]
...
if total_per_window:
    ...
    print("No fixations found in the 10s windows after first entries!")